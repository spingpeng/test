...
<body>
<form name="form1" method="post" action="updatePayout.action">
<input type=hidden name="payout.payoutId" value="<s:property value="payout.payoutId"/>" />
<input type=hidden name="payout.user.userId" value="<s:property value="payout.user.userId"/>" />
    ...
    <tbody>
     ...
     <tr bgcolor="#DEE5FA">
      ...
      <!--  <s:textfield name="payout.payTime" ></s:textfield>-->
        <input name="payout.payTime" id="d4311" onfocus="WdatePicker()" type="text"  tabindex="1"  rel="payout.payTime" class="Wdate"  value="<s:date format="yyyy-MM-dd" name='payout.payTime'/>"/>
        </td>
