...
<body>
<form name="form1" method="post" action="addIncome.action">
  ...
  <table width="1052" border=0 align=center cellpadding=2 cellspacing=1 bordercolor="#799AE1" class=tableBorder>
    ...
    <input name="income.inTime" id="d4311" onfocus="WdatePicker()" type="text"  tabindex="1"  rel="income.inTime" class="Wdate"  value="<s:property value='income.inTime'/>"/>
      </td>
