...
<input type="hidden" name="user2.userName" value="<s:property value="user2.userName"/>" />
  <table width="1052" border=0 align=center cellpadding=2 cellspacing=1 bordercolor="#799AE1" class=tableBorder>
    <tbody>
      ...
      <tr align="center" bgcolor="#799AE1">
        ...
        <td align="left" class=txlrow><s:text name="user2.userName" ></s:text></td>
        
      </tr>
   
      <tr bgcolor="#DEE5FA">
        <td align="center" class="txlHeaderBackgroundAlternate">密码 </td>
        <td align=left class=txlrow><s:textfield name="user2.password" ></s:textfield></td>
